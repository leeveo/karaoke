    ...
    <>
      ...
      >
        ...
        <div className="z-10 w-full max-w-5xl flex flex-col items-center">
          ...
          <h1 
            className="text-3xl font-bold mb-8 text-center px-8 py-4 rounded-2xl"
            style={{ 
              color: 'white',
          ...
          <div className="mt-6 flex flex-wrap gap-5 justify-center items-center">
            <button
            ...
            <button
              ...
              className={`
                ...
                font-extrabold py-8 px-16 text-4xl
            ...
            >
              {isUploading ? (
                <>
                  <svg className="animate-spin -ml-1 mr-2 h-10 w-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
