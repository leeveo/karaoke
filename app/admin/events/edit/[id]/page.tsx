...
export default function EditEventPage() {
  ...
  // Convert Event to EventInput with default customization
  const getFormData = (eventData: Event): EventInput => {
    return {
      name: eventData.name,
      date: eventData.date,
  ...
  return (
    <div className="p-6">
      ...
      <EventForm onSubmit={handleSubmit} initialData={getFormData(event)} />
    </div>
  );
}